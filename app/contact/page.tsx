        ...
        <div className="mx-auto max-w-[720px]">
          ...
          <section>
            <div className="flex gap-4 flex-wrap">
              <Link href="/about" className="text-[14px] text-[#1f2328] underline hover:no-underline">About us</Link>
              <Link href="/privacy-policy" className="text-[14px] text-[#1f2328] underline hover:no-underline">Privacy policy</Link>
              <Link href="/blog" className="text-[14px] text-[#1f2328] underline hover:no-underline">EV guides</Link>
            </div>
          </section>
        </div>
      </main>
