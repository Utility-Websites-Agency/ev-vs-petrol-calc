        ...
        <div className="mx-auto max-w-[720px]">
          ...
          <section className="mb-8">
            ...
            <p className="text-[16px] text-[#5f676f] leading-[28px]">
              ...
              <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-[#5e6ad2] hover:underline">
                Google's Ad Settings
              </a>{" "}
              or{" "}
              <a href="https://www.aboutads.info/choices/" target="_blank" rel="noopener noreferrer" className="text-[#5e6ad2] hover:underline">
                aboutads.info
              </a>.
            </p>
          </section>
