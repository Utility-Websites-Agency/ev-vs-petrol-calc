    ...
    <div className="flex flex-col min-h-screen bg-white font-sans text-[#1f2328]">
      ...
      <main className="flex-1 px-6 py-16">
        <div className="mx-auto max-w-[720px]">
          ...
          <p className="text-[13px] text-[#4a4c4d] mb-10">Last updated: 30 April 2026</p>

          <p className="text-[16px] text-[#4a4c4d] leading-[28px] mb-10">
          ...
          <section className="mb-8">
            ...
            <p className="text-[16px] text-[#4a4c4d] leading-[28px] mb-3">
          ...
          <section className="mb-8">
            ...
            <ul className="flex flex-col gap-2 text-[16px] text-[#4a4c4d] leading-[28px] list-disc list-inside">
            ...
            <p className="text-[16px] text-[#4a4c4d] leading-[28px] mt-3">
